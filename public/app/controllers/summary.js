export async function summary() {
  console.log('Soy el controller del Summary');
}


// Define tu instrucción personalizada
const systemInstruction = `Eres un experto en extracción de datos. Tu tarea es analizar el contenido proporcionado (imagen o texto) y extraer estrictamente los valores correspondientes al nombre de usuario y la contraseña. El resultado debe ser un objeto JSON con las claves "usuario" y "contraseña". Si no encuentras un valor, la clave correspondiente debe tener el valor "null".`;
...
async function queryGeminiModel(prompt) {
...
function showToast(message, type = 'success') {
  try{
    ...
    console.log("El toast se mostro correctamente jajaja");
  } catch(error){
    console.error("Error al intentar mostrar el toast:", error);
  }
}
